...
public class MensajeSalidaPruebas
{
    ...
    public void Fallo_programa_reintento_y_cuenta_intentos()
    {
        ...
        Assert.Equal(EstadoMensajeSalida.Error, mensaje.Estado);
    ...
    public void Error_largo_se_trunca()
    {
        ...
        mensaje.RegistrarFallo(new string('x', MensajeSalida.LargoMaximoError + 500), Ahora);

        Assert.Equal(MensajeSalida.LargoMaximoError, mensaje.UltimoError!.Length);
    }
