...
def escribir_enrolamiento(carpeta, base):
    """Huella del equipo en la credencial y tabla de solicitudes, para un Central que ya está en uso."""
    escribir(carpeta, f"""/*
    CG-POS · Enrolamiento de cajas en «{base}»
    ...
    su credencial queda atada al equipo que la pidió, así que la misma credencial no sirve en otra máquina.
        ...
        sqlcmd -S .\\SQLEXPRESS -E -d {base} -i agregar-enrolamiento-cajas.sql
...
GO
""", nombre='agregar-enrolamiento-cajas.sql')
...
escribir_enrolamiento('central', 'CgPosCentral')
