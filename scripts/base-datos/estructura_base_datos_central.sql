...
VALUES
    ...
    (35, N'Caja.SuspenderRequiereAutorizacion', N'false', N'Suspender la caja pide autorización de un supervisor', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (36, N'Numeracion.DigitosSecuencia', N'7', N'Dígitos de la secuencia en el número de los documentos', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (37, N'Pantallas.SegundosAviso', N'6', N'Segundos que dura un aviso en la pantalla de la caja antes de quitarse solo (0 = hasta que lo cierren)', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (38, N'Fiscal.MontoIdentificacionConsumo', N'250000', N'Total desde el cual la factura de consumo exige cédula o RNC', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (39, N'Fiscal.PorcentajeAlertaSecuenciaEcf', N'10', N'Porcentaje restante de un rango de e-CF desde el cual se alerta', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (40, N'Fiscal.ComprobantesAlertaSecuenciaEcf', N'10', N'Cantidad de comprobantes restantes de un rango de e-CF desde la cual se alerta al facturar', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (41, N'Fiscal.DiasAlertaCertificado', N'30', N'Días antes del vencimiento del certificado para alertar', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (42, N'Fiscal.PorcentajeRetencionLey3223', N'0', N'Retención de la Ley 32-23 en facturas gubernamentales E45 (0 = sin retención)', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (43, N'Devoluciones.DiasRetencionImpuesto', N'30', N'Días desde la factura tras los cuales la devolución retiene el ITBIS', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (44, N'Devoluciones.DiasVigenciaNotaCredito', N'180', N'Días desde la emisión en que se puede consumir una nota de crédito', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (45, N'Fidelidad.ValorPunto', N'1', N'Valor en dinero de cada punto al canjearlo', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (46, N'Fidelidad.MesesVigenciaPuntos', N'12', N'Meses que duran los puntos acumulados', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (47, N'Fidelidad.MinimoPuntosCanje', N'50', N'Puntos mínimos para poder canjear', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (48, N'Fidelidad.MaximoPuntosCanjeSinConexion', N'2000', N'Tope de puntos a canjear sin conexión con el Central', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (49, N'Sincronizacion.DiasRetencionXmlEnviados', N'90', N'Días que se conservan los XML ya enviados', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (50, N'Sincronizacion.DiasRetencionMensajesConfirmados', N'60', N'Días que se conservan los mensajes confirmados', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (51, N'Sincronizacion.AlertaTamanoBaseDatosMb', N'8000', N'Tamaño de la base de la caja que dispara alerta', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (52, N'Sincronizacion.HorasAlertaPendientes', N'24', N'Horas con documentos sin sincronizar que disparan alerta', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (53, N'Respaldo.DiasRetencion', N'7', N'Días que se conservan los respaldos de la caja', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (54, N'Reloj.ToleranciaSegundos', N'60', N'Diferencia de hora tolerada contra el servidor NTP', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (55, N'Balanza.PrefijoPeso', N'21', N'Prefijo de las etiquetas de balanza con peso', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (56, N'Balanza.PrefijoPrecio', N'22', N'Prefijo de las etiquetas de balanza con precio', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (57, N'Balanza.DigitosCodigoArticulo', N'5', N'Dígitos del código del artículo en la etiqueta', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (58, N'Balanza.DigitosValor', N'5', N'Dígitos del valor en la etiqueta', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (59, N'Balanza.DecimalesPeso', N'3', N'Decimales del peso en la etiqueta', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (60, N'Balanza.DecimalesPrecio', N'2', N'Decimales del precio en la etiqueta', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación');
ALTER SEQUENCE [SecuenciaParametros] RESTART WITH 71;
GO
