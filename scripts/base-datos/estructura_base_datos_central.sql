...
VALUES (1, N'ADMIN', N'Administrador del sistema', NULL, 1, 1, 'PBKDF2-SHA256$600000$8ndCgYo1prge/akZZY1N/A==$5wnz3eLn/R2xtZ7mwk/LsO6jkgr9x5GyerslYASP0/s=', 1, NULL, 0, NULL, NULL,
...
VALUES
    ...
    (10, N'Central.Dgii.SegundosCiclo', N'30', N'Segundos entre envíos de e-CF a la DGII', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (11, N'Central.Dgii.LoteEnvio', N'50', N'Comprobantes por lote de envío a la DGII', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (12, N'Central.Dgii.MinutosReintento', N'5', N'Minutos antes de reintentar un envío fallido', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (13, N'Central.Dgii.MinutosMaximoReintento', N'120', N'Tope de espera entre reintentos', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (14, N'Central.Dgii.SegundosConsultaEstado', N'60', N'Segundos entre consultas del resultado a la DGII', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (15, N'Central.Monitor.MinutosSinComunicacion', N'30', N'Minutos sin comunicación tras los que una caja es alerta', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (16, N'Central.Monitor.MinutosAlertaDgii', N'60', N'Minutos sin resultado de la DGII tras los que un e-CF es alerta', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (17, N'Central.NotasCredito.MinutosReserva', N'10', N'Minutos que se retiene el saldo de una nota mientras la caja cobra', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (18, N'Central.Devoluciones.MinutosReserva', N'10', N'Minutos que se retienen las líneas de una factura mientras otra tienda le hace la nota de crédito', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (19, N'Central.Fidelidad.MinutosCicloVencimiento', N'60', N'Minutos entre revisiones de los puntos vencidos', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (20, N'Central.Fidelidad.LoteVencimiento', N'500', N'Miembros por lote al vencer puntos', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (21, N'Central.Cotizaciones.DiasVigencia', N'15', N'Días que vale una cotización desde que se hace', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (22, N'Central.Despacho.MinutosCicloAvisos', N'15', N'Minutos entre avisos de pedidos preparados', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (23, N'Central.Despacho.LoteAvisos', N'50', N'Avisos por lote', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (24, N'Seguridad.IntentosMaximosClave', N'3', N'Intentos de clave fallidos que bloquean al usuario de la caja', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (25, N'Seguridad.MinutosBloqueo', N'5', N'Minutos que dura el bloqueo del usuario de la caja', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (26, N'Seguridad.MinutosVigenciaAutorizacion', N'5', N'Minutos para usar una autorización de supervisor', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    ...
    (33, N'Numeracion.DigitosSecuencia', N'7', N'Dígitos de la secuencia en el número de los documentos', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (34, N'Fiscal.MontoIdentificacionConsumo', N'250000', N'Total desde el cual la factura de consumo exige cédula o RNC', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (35, N'Fiscal.PorcentajeAlertaSecuenciaEcf', N'10', N'Porcentaje restante de un rango de e-CF desde el cual se alerta', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (36, N'Fiscal.DiasAlertaCertificado', N'30', N'Días antes del vencimiento del certificado para alertar', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (37, N'Fiscal.PorcentajeRetencionLey3223', N'0', N'Retención de la Ley 32-23 en facturas gubernamentales E45 (0 = sin retención)', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (38, N'Devoluciones.DiasRetencionImpuesto', N'30', N'Días desde la factura tras los cuales la devolución retiene el ITBIS', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (39, N'Devoluciones.DiasVigenciaNotaCredito', N'180', N'Días desde la emisión en que se puede consumir una nota de crédito', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (40, N'Fidelidad.ValorPunto', N'1', N'Valor en dinero de cada punto al canjearlo', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (41, N'Fidelidad.MesesVigenciaPuntos', N'12', N'Meses que duran los puntos acumulados', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (42, N'Fidelidad.MinimoPuntosCanje', N'50', N'Puntos mínimos para poder canjear', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (43, N'Fidelidad.MaximoPuntosCanjeSinConexion', N'2000', N'Tope de puntos a canjear sin conexión con el Central', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (44, N'Sincronizacion.DiasRetencionXmlEnviados', N'90', N'Días que se conservan los XML ya enviados', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (45, N'Sincronizacion.DiasRetencionMensajesConfirmados', N'60', N'Días que se conservan los mensajes confirmados', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (46, N'Sincronizacion.AlertaTamanoBaseDatosMb', N'8000', N'Tamaño de la base de la caja que dispara alerta', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (47, N'Sincronizacion.HorasAlertaPendientes', N'24', N'Horas con documentos sin sincronizar que disparan alerta', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (48, N'Respaldo.DiasRetencion', N'7', N'Días que se conservan los respaldos de la caja', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (49, N'Reloj.ToleranciaSegundos', N'60', N'Diferencia de hora tolerada contra el servidor NTP', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (50, N'Balanza.PrefijoPeso', N'21', N'Prefijo de las etiquetas de balanza con peso', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (51, N'Balanza.PrefijoPrecio', N'22', N'Prefijo de las etiquetas de balanza con precio', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (52, N'Balanza.DigitosCodigoArticulo', N'5', N'Dígitos del código del artículo en la etiqueta', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (53, N'Balanza.DigitosValor', N'5', N'Dígitos del valor en la etiqueta', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (54, N'Balanza.DecimalesPeso', N'3', N'Decimales del peso en la etiqueta', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación'),
    (55, N'Balanza.DecimalesPrecio', N'2', N'Decimales del precio en la etiqueta', NULL, NULL, SYSDATETIMEOFFSET(), N'Instalación');
