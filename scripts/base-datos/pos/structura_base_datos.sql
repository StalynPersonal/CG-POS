...
CREATE SEQUENCE [SecuenciaCierresTurnoDenominaciones] START WITH 1 INCREMENT BY 10 NO CYCLE;
GO


CREATE SEQUENCE [SecuenciaCierresTurnoFormasPago] START WITH 1 INCREMENT BY 10 NO CYCLE;
GO
...
CREATE SEQUENCE [SecuenciaDestinosEntregaVenta] START WITH 1 INCREMENT BY 10 NO CYCLE;
GO


CREATE SEQUENCE [SecuenciaDevoluciones] START WITH 1 INCREMENT BY 10 NO CYCLE;
GO
...
CREATE SEQUENCE [SecuenciaDocumentosElectronicos] START WITH 1 INCREMENT BY 10 NO CYCLE;
GO
...
CREATE SEQUENCE [SecuenciaEntregasPendiente] START WITH 1 INCREMENT BY 10 NO CYCLE;
GO
...
CREATE SEQUENCE [SecuenciaHistorialEstadosEcf] START WITH 1 INCREMENT BY 10 NO CYCLE;
GO
...
CREATE SEQUENCE [SecuenciaLineasDestinoEntrega] START WITH 1 INCREMENT BY 10 NO CYCLE;
GO


CREATE SEQUENCE [SecuenciaLineasDevolucion] START WITH 1 INCREMENT BY 10 NO CYCLE;
GO


CREATE SEQUENCE [SecuenciaLineasEntregaPendiente] START WITH 1 INCREMENT BY 10 NO CYCLE;
GO


CREATE SEQUENCE [SecuenciaLineasPendienteEntrega] START WITH 1 INCREMENT BY 10 NO CYCLE;
GO
...
CREATE SEQUENCE [SecuenciaMovimientosCaja] START WITH 1 INCREMENT BY 10 NO CYCLE;
GO
...
CREATE SEQUENCE [SecuenciaOperacionesTerminal] START WITH 1 INCREMENT BY 10 NO CYCLE;
GO
...
CREATE SEQUENCE [SecuenciaPreciosArticulo] START WITH 1 INCREMENT BY 10 NO CYCLE;
GO
...
CREATE SEQUENCE [SecuenciaRoles] START WITH 1 INCREMENT BY 10 NO CYCLE;
GO
...
CREATE SEQUENCE [SecuenciaTurnos] START WITH 1 INCREMENT BY 10 NO CYCLE;
GO
...
CREATE SEQUENCE [SecuenciaUsuarios] START WITH 1 INCREMENT BY 10 NO CYCLE;
GO


CREATE SEQUENCE [SecuenciaVentas] START WITH 1 INCREMENT BY 10 NO CYCLE;
GO
