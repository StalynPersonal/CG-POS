...
public static class RutasApiDespacho
{
    ...
    public static IEndpointRouteBuilder MapearApiDespacho(this IEndpointRouteBuilder aplicacion)
    {
        ...
        manager.MapGet("/pendientes", async (string? buscar, EstadoPendiente? estado, MetodoEntrega? metodo, Guid? sucursalId, bool? soloAtrasados,
        ...
        manager.MapGet("/pendientes/{pendienteId:guid}", async (Guid pendienteId, IServicioDespachoCentral servicio, CancellationToken cancelacion) =>
